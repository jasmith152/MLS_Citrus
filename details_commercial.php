...
$output .= "     <tr><td width='15%'><b>Cross Street:</b> </td><td width='40%'>".$data_listing[$db_cross_street]."</td>\n";
$output .= "     <td width='20%'><b>Rear Expo:</b> </td><td width='45%'>".$data_listing[$db_RearExposureCode]."</td></tr>\n";
...
$output .= "     <td><b>Year Built:</b> </td><td>".$data_listing[$db_year_built]."</td></tr>\n";
$output .= "     <tr><td><b>Bldg Stories:</b> </td><td>".$data_listing[$db_stories]."</td>\n";
$output .= "     <td><b>Apx. Acres:</b> </td><td>".$data_listing[$db_acres]."</td></tr>\n";
$output .= "     <tr><td><b>Park Spaces:</b> </td><td>".$data_listing[$db_parking_spaces]."</td>\n";
$output .= "     <td><b>Apx. Net Leaseable SqFt:</b> </td><td>".$data_listing[$db_apx_net_leaseable_sqft]."</td></tr>\n";
$output .= "     <tr><td><b>Waterfront:</b> </td><td>".$data_listing[$db_waterfront_yn]."</td>\n";
$output .= "     <td><b>Apx. Bldg SqFt:</b> </td><td>".$data_listing[$db_total_sqft]."</td></tr>\n";
$output .= "     <tr><td><b>Waterfront Ft:</b> </td><td>".$data_listing[$db_waterfrontage]."</td>\n";
$output .= "     <td><b>Sec/Twp/Rng:</b> </td><td>".$data_listing[$db_tax_sec]."/".$data_listing[$db_tax_twp]."/".$data_listing[$db_tax_rng]."</td></tr>\n";
$output .= "     <tr><td><b>Load Docks:</b> </td><td>".$data_listing[$db_NumOfLoadingDocks]."</td>\n";
$output .= "     <td><b>Apx. Land SqFt:</b> </td><td>".$data_listing[$db_land_sqFt]."</td></tr>\n";
$output .= "     <tr><td><b>Rails:</b> </td><td>".$data_listing[$db_rails]."</td>\n";
$output .= "     <td><b>Asset Sales:</b> </td><td>".$data_listing[$db_asset_sales]."</td></tr>\n";
$output .= "     <tr><td><b>Apx. Lot Size:</b> </td><td>".$data_listing[$db_lot_size]."</td>\n";
$output .= "     <td colspan='2'><b></b></td></tr>\n";
$output .= "     <tr><td valign='top'><b>Public Rems:</b> </td><td colspan='3' valign='top'>".$data_listing[$db_public_remarks]."</td></tr>\n";
$output .= "     <tr><td valign='top'><b>Directions:</b> </td><td colspan='3' valign='top'>".$data_listing[$db_directions]."</td></tr>\n";
$output .= "   </table>\n";
$output .= "  </td>\n";
$output .= " </tr>\n";
$output .= " <tr>\n";
...
$output .= "   </table><br />\n";
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
$output .= "     <tr><td><b>Curr Bldg Use:</b> </td><td>".$data_listing[$db_building_use]."</td>\n";
$output .= "     <td><b>Lot Desc:</b> </td><td>".$data_listing[$db_lot_descr]."</td></tr>\n";
$output .= "     <tr><td><b>Sewer/Water:</b> </td><td>".$data_listing[$db_sewer_water]."</td>\n";
$output .= "     <td><b>Floor:</b> </td><td>".$data_listing[$db_floor]."</td></tr>\n";
$output .= "     <tr><td><b>Const/Foundation:</b> </td><td>".$data_listing[$db_const_foundation]."</td>\n";
$output .= "     <td><b>Heat/Cool:</b> </td><td>".$data_listing[$db_heat_cool]."</td></tr>\n";
$output .= "     <tr><td><b>Terms Avail:</b> </td><td>".$data_listing[$db_terms_available]."</td>\n";
$output .= "     <td><b>Roof:</b> </td><td>".$data_listing[$db_roof]."</td></tr>\n";
$output .= "     <tr><td><b>Energy Feat:</b> </td><td>".$data_listing[$db_energy_features]."</td>\n";
$output .= "     <td><b>Parking:</b> </td><td>".$data_listing[$db_parking]."</td></tr>\n";
//$output .= "     <td><b>Const/Found:</b> </td><td>".$data_listing[$db_const_foundation]."</td>\n";
$output .= "     <tr><td><b>Possession:</b> </td><td>".$data_listing[$db_possession]."</td>\n";
$output .= "     <td><b>Road Type:</b> </td><td>".$data_listing[$db_road_type]."</td></tr>\n";
...
$output .= "     <tr><td><b>Terms Avail:</b> </td><td>".$data_listing[$db_terms_available]."</td>\n";
$output .= "     <td><b>Short Sale:</b> </td><td>".$data_listing[$db_shortsale_yn]."</td></tr>\n";
//$output .= "     <td><b>Foreclosure:</b> </td><td>".$data_listing['LM_MST_FORCL_YN']."</td></tr>\n";
$output .= "     <tr><td colspan='2'></td>\n";
$output .= "     <td colspan='2'></td></tr>\n";
$output .= "   </table><br />\n";
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
$output .= "     <tr><td><b>Cap Rate%:</b> </td><td>".$data_listing[$db_cap_rate_percent]."</td>\n";
$output .= "     <td><b>Ann. Gross Inc:</b> </td><td>".$data_listing[$db_gross_income]."</td>\n";
$output .= "     <td><b>Ann. Expense:</b> </td><td>".$data_listing[$db_annual_expenses]."</td>\n";
$output .= "     <td><b>Ann. Utilities:</b> </td><td>".$data_listing[$db_utilities]."</td></tr>\n";
$output .= "     <tr><td><b>Net Income:</b> </td><td>".$data_listing[$db_NetIncome]."</td>\n";
$output .= "     <td><b>Ann. Mgmt Exp:</b> </td><td>$".$data_listing[$db_ann_mgmt_expenses]."</td>\n";
$output .= "     <td><b>Ann. Insur:</b> </td><td>".$data_listing[$db_ann_insurance]."</td>\n";
$output .= "     <td><b>Other Expense:</b> </td><td>".$data_listing[$db_other_expenses]."</td></tr>\n";
$output .= "     <tr><td><b>Ann. Taxes:</b> </td><td>".$data_listing[$db_ann_taxes]."</td>\n";
...
$output .= "     <td><b>Rear Exposure:</b> </td><td>".$data_listing[$db_RearExposureCode]."</td></tr>\n";

$output .= "     <tr><td><b>Age:</b> </td><td>".$data_listing[$db_age]."</td>\n";
$output .= "     <td><b>Agent IDX:</b> </td><td>".$data_listing[$AgentIDX]."</td></tr>\n";
//$output .= "     <tr><td><b>Agent Status:</b> </td><td>".$data_listing[$db_AgentStatus]."</td>\n";
//$output .= "     <td><b>Annual Expenses:</b> </td><td>".$data_listing[$db_AnnualExpenses]."</td></tr>\n";
//$output .= "     <tr><td><b>Annual Sales:</b> </td><td>".$data_listing[$db_AnnualSales]."</td>\n";
$output .= "     <td><b>AVMYN:</b> </td><td>".$data_listing[$db_AVMYN]."</td></tr>\n";
$output .= "     <tr><td><b>db_BathsHalf:</b> </td><td>".$data_listing[$db_BathsHalf]."</td>\n";
//$output .= "     <td><b>Business Desc:</b> </td><td>".$data_listing[$db_BusinessDesc]."</td></tr>\n";
//$output .= "     <tr><td><b>Business Name:</b> </td><td>".$data_listing[$db_BusinessName]."</td>\n";
$output .= "     <td><b>Compass Suffix:</b> </td><td>".$data_listing[$db_CompassSuffix]."</td></tr>\n";
$output .= "     <tr><td><b>Date Change:</b> </td><td>".$data_listing[$db_DateChange]."</td>\n";
//$output .= "     <td><b>Desc Of Leased Equipment:</b> </td><td>".$data_listing[$db_DescOfLeasedEquipment]."</td></tr>\n";
//$output .= "     <tr><td><b>Desc Of Owned Equipment:</b> </td><td>".$data_listing[$db_DescOfOwnedEquipment]."</td>\n";
$output .= "     <td><b>Display Flag Address:</b> </td><td>".$data_listing[$db_display_flag_address]."</td></tr>\n";
$output .= "     <tr><td><b>Display Flag Listing:</b> </td><td>".$data_listing[$db_display_flag_listing]."</td>\n";
//$output .= "     <td><b>Est Inventory Dol:</b> </td><td>".$data_listing[$db_EstInventoryDol]."</td></tr>\n";
//$output .= "     <tr><td><b>Full Time Employees:</b> </td><td>".$data_listing[$db_FullTimeEmployees]."</td>\n";
//$output .= "     <td><b>db_LeaseRemaining:</b> </td><td>".$data_listing[$db_LeaseRemaining]."</td></tr>\n";
$output .= "     <tr><td><b>Lease:</b> </td><td>".$data_listing[$db_LeaseYN]."</td>\n";
$output .= "     <td><b>List Agent Office ID:</b> </td><td>".$data_listing[$db_list_agent_officeID]."</td></tr>\n";
$output .= "     <tr><td><b>List Date:</b> </td><td>".$data_listing[$db_list_date]."</td>\n";
$output .= "     <td><b>Listing Agent Name:</b> </td><td>".$data_listing[$db_listing_agent_name]."</td></tr>\n";
$output .= "     <tr><td><b>Listing Area:</b> </td><td>".$data_listing[$db_listing_area]."</td>\n";
$output .= "     <td><b>Listing Board ID:</b> </td><td>".$data_listing[$db_listing_boardID]."</td></tr>\n";
$output .= "     <tr><td><b>Listing Office ID:</b> </td><td>".$data_listing[$db_ListingOfficeID]."</td>\n";
$output .= "     <td><b>Listing Status:</b> </td><td>".$data_listing[$db_ListingStatus]."</td></tr>\n";
$output .= "     <tr><td><b>Listing Type:</b> </td><td>".$data_listing[$db_ListingType]."</td>\n";
$output .= "     <td><b>Lot Dimensions:</b> </td><td>".$data_listing[$db_LotDimensions]."</td></tr>\n";
$output .= "     <tr><td><b>Modification Time stamp:</b> </td><td>".$data_listing[$db_ModificationTimestamp]."</td>\n";
//$output .= "     <td><b>Monthly Bldg Exp:</b> </td><td>".$data_listing[$db_MonthlyBldgExp]."</td></tr>\n";
$output .= "     <tr><td><b>Monthly Dues Dol:</b> </td><td>".$data_listing[$db_MonthlyDuesDol]."</td>\n";
//$output .= "     <td><b>Net Income:</b> </td><td>".$data_listing[$db_NetIncome]."</td></tr>\n";
$output .= "     <tr><td><b>Occupancy Desc:</b> </td><td>".$data_listing[$db_OccupancyDesc]."</td>\n";
$output .= "     <td><b>Occupant Name:</b> </td><td>".$data_listing[$db_OccupantName]."</td></tr>\n";
$output .= "     <tr><td><b>Office IDX:</b> </td><td>".$data_listing[$db_OfficeIDX]."</td>\n";
$output .= "     <td><b>Office Status:</b> </td><td>".$data_listing[$db_OfficeStatus]."</td></tr>\n";
//$output .= "     <tr><td><b>Part Time Employees:</b> </td><td>".$data_listing[$db_PartTimeEmployees]."</td>\n";
$output .= "     <td><b>Photo Count:</b> </td><td>".$data_listing[$db_photo_count]."</td></tr>\n";
$output .= "     <tr><td><b>Photo Modification Time stamp:</b> </td><td>".$data_listing[$db_PhotoModificationTimestamp]."</td>\n";
$output .= "     <td><b>Property Sub Type:</b> </td><td>".$data_listing[$db_PropertySubType]."</td></tr>\n";
//$output .= "     <tr><td><b>Rear Exposure Code:</b> </td><td>".$data_listing[$db_RearExposureCode]."</td>\n";
//$output .= "     <td><b>Reason For Selling:</b> </td><td>".$data_listing[$db_ReasonForSelling]."</td></tr>\n";
$output .= "     <tr><td><b>Showing:</b> </td><td>".$data_listing[$db_Showing]."</td>\n";
$output .= "     <td><b>State Or Province:</b> </td><td>".$data_listing[$db_StateOrProvince]."</td></tr>\n";
//$output .= "     <tr><td><b>Status Change Date:</b> </td><td>".$data_listing[$db_StatusChangeDate]."</td>\n";
$output .= "     <td><b>Tax ID:</b> </td><td>".$data_listing[$db_TaxID]."</td></tr>\n";
$output .= "     <tr><td><b>Var Dual Rate Comm:</b> </td><td>".$data_listing[$db_VarDualRateCommYN]."</td>\n";
$output .= "     <td><b>Virtual Tour:</b> </td><td>".$data_listing[$db_VirtualTourYN]."</td></tr>\n";
$output .= "     <tr><td><b>VOWAVMYN:</b> </td><td>".$data_listing[$db_VOWAVMYN]."</td>\n";
$output .= "     <td><b>VOW Comments:</b> </td><td>".$data_listing[$db_VOWCommentsYN]."</td></tr>\n";
//$output .= "     <tr><td><b>Year Started:</b> </td><td>".$data_listing[$db_YrStarted]."</td>\n";
$output .= "     <td><b></b> </td><td></td></tr>\n";
$output .= "   </table><br />\n";
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
