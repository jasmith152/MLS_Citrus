...
$output .= "     <td width='20%'><b># Units:</b> </td><td width='45%'>".$data_listing[$db_units]."</td></tr>\n";
...
$output .= "     <tr><td><b>Bldg Stories:</b> </td><td></td>\n";
$output .= "     <td><b>Apx. Acres:</b> </td><td>".$data_listing[$db_acres]."</td></tr>\n";
//$output .= "     <tr><td><b>Park Spaces:</b> </td><td></td>\n";
$output .= "     <tr><td><b>Apx. Net Leaseable SqFt:</b> </td><td>".$data_listing[$db_living_sqft]."</td>\n";
$output .= "     <td><b>Waterfront:</b> </td><td>".$data_listing[$db_waterfront_yn]."</td></tr>\n";
$output .= "     <tr><td><b>Apx. Bldg SqFt:</b> </td><td>".$data_listing[$db_total_sqft]."</td>\n";
$output .= "     <td><b>Waterfront Ft:</b> </td><td>".$data_listing[$db_waterfrontage]."</td></tr>\n";
$output .= "     <tr><td><b>Apx. Land SqFt:</b> </td><td>".$data_listing[$db_lot_size]."</td>\n";
//$output .= "     <tr><td><b>Load Docks:</b> </td><td".$data_listing[$db_waterfrontage]."></td>\n";
$output .= "     <td><b>Sec/Twp/Rng:</b> </td><td>".$data_listing[$db_tax_sec]."/".$data_listing[$db_tax_twp]."/".$data_listing[$db_tax_rng]."</td></tr>\n";
//$output .= "     <tr><td><b>Rails:</b> </td><td></td>\n";
//$output .= "     <td><b>Alt Key:</b> </td><td>".$data_listing[$db_county]."</td></tr>\n";
$output .= "     <tr><td><b>Asset Sales:</b> </td><td>".$data_listing[$db_asset_sales]."</td>\n";
//$output .= "     <td><b>Land Use:</b> </td><td>".$data_listing[$db_zoning]."</td></tr>\n";
$output .= "     <td><b>Apx. Lot Size:</b> </td><td>".$data_listing[$db_lot_size]."</td></tr>\n";
...
$output .= "   </table><br />\n";
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
//$output .= "     <td><b>Curr Bldg Use:</b> </td><td>".$data_listing[$db_master_bedbath]."</td>\n";
$output .= "     <tr><td><b>Lot Desc:</b> </td><td>".$data_listing[$db_lot_descr]."</td>\n";
$output .= "     <td><b>Sewer/Water:</b> </td><td>".$data_listing[$db_sewer_water]."</td></tr>\n";
$output .= "     <tr><td><b>Floor:</b> </td><td>".$data_listing[$db_floor]."</td>\n";
$output .= "     <td><b>Const/Foundation:</b> </td><td>".$data_listing[$db_const_foundation]."</td></tr>\n";
...
//$output .= "     <td><b>Sewer/Water:</b> </td><td>".$data_listing[$db_sewer_water]."</td></tr>\n";
$output .= "     <tr><td><b>Roof:</b> </td><td>".$data_listing[$db_roof]."</td>\n";
$output .= "     <td><b>Energy Feat:</b> </td><td>".$data_listing[$db_energy_features]."</td></tr>\n";
//$output .= "     <tr><td><b>Parking:</b> </td><td>".$data_listing[$db_const_foundation]."</td>\n";
...
$output .= "     <td><b>Display Flag Address:</b> </td><td>".$data_listing[$db_DisplayFlagAddress]."</td></tr>\n";
$output .= "     <tr><td><b>Display Flag Listing:</b> </td><td>".$data_listing[$db_DisplayFlagListing]."</td>\n";
...
$output .= "     <td><b>List Agent Office ID:</b> </td><td>".$data_listing[$db_ListAgentOfficeID]."</td></tr>\n";
$output .= "     <tr><td><b>List Date:</b> </td><td>".$data_listing[$db_ListDate]."</td>\n";
$output .= "     <td><b>Listing Agent Name:</b> </td><td>".$data_listing[$db_ListingAgentName]."</td></tr>\n";
$output .= "     <tr><td><b>Listing Area:</b> </td><td>".$data_listing[$db_ListingArea]."</td>\n";
$output .= "     <td><b>Listing Board ID:</b> </td><td>".$data_listing[$db_ListingBoardID]."</td></tr>\n";
...
$output .= "     <td><b>Photo Count:</b> </td><td>".$data_listing[$db_PhotoCount]."</td></tr>\n";
