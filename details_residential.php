...
//$output .= "     <td width='20%'><b>Rear Expo:</b> </td><td width='45%'>".$data_listing['LM_MST_DRFCES']."</td></tr>\n";
...
$output .= "     <td><b>Apx. SqFt Under Roof:</b> </td><td>".$data_listing[$db_living_sqft]."</td></tr>\n";
$output .= "     <tr><td><b>Baths:</b> </td><td>".$data_listing[$db_baths]."</td>\n";
$output .= "     <td><b>Apx. Liv. SqFt:</b> </td><td>".$data_listing[$db_total_sqft]."</td></tr>\n";
$output .= "     <tr><td><b>Waterfront:</b> </td><td>".$data_listing[$db_waterfront_yn]."</td>\n";
$output .= "     <td><b>Alt Key:</b> </td><td>".$data_listing[$db_parcel_number]."</td></tr>\n";
...
$output .= "     <td><b>Private Pool:</b> </td><td>".$data_listing[$db_pool_yn]."</td></tr>\n";
...
$output .= " </tr>\n";
/*$output .= " <tr>\n";
$output .= "  <td align='center' style='background-color: #999;font-size: 14px;font-weight: bold;'>Approx. Room Dimensions</td>\n";
$output .= " </tr>\n";
$output .= " <tr>\n";
$output .= "  <td align='center'>\n";
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
$output .= "     <tr><td><b>Living Room:</b> </td><td>";
if (!empty($data_listing['LM_RES_LIV_LNG']) && !empty($data_listing['LM_RES_LIV_WTH'])) { $output .= $data_listing['LM_RES_LIV_LNG']."X".$data_listing['LM_RES_LIV_WTH']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>MBR:</b> </td><td>";
if (!empty($data_listing['LM_RES_MBR_L']) && !empty($data_listing['LM_RES_MBR_W'])) { $output .= $data_listing['LM_RES_MBR_L']."X".$data_listing['LM_RES_MBR_W']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>Den:</b> </td><td>";
if (!empty($data_listing['LM_RES_DFR_L']) && !empty($data_listing['LM_RES_DFR_W'])) { $output .= $data_listing['LM_RES_DFR_L']."X".$data_listing['LM_RES_DFR_W']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>Screen Porch:</b> </td><td>";
if (!empty($data_listing['LM_RES_POR_DIM1']) && !empty($data_listing['LM_RES_POR_DIM2'])) { $output .= $data_listing['LM_RES_POR_DIM1']."X".$data_listing['LM_RES_POR_DIM2']; } else { $output .= "&nbsp;"; }
$output .= "     </td></tr>\n";
$output .= "     <tr><td><b>Great Room:</b> </td><td>";
if (!empty($data_listing['LM_RES_GRLEN']) && !empty($data_listing['LM_RES_GRWIDTH'])) { $output .= $data_listing['LM_RES_GRLEN']."X".$data_listing['LM_RES_GRWIDTH']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>BR 2:</b> </td><td>";
if (!empty($data_listing['LM_RES_BR2_L']) && !empty($data_listing['LM_RES_BR2_W'])) { $output .= $data_listing['LM_RES_BR2_L']."X".$data_listing['LM_RES_BR2_W']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>Florida Room:</b> </td><td>";
if (!empty($data_listing['LM_RES_DFLORIDA'])) { $output .= $data_listing['LM_RES_DFLORIDA']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>Lanai:</b> </td><td>";
if (!empty($data_listing['LM_RES_LANAILEN']) && !empty($data_listing['LM_RES_LANAIWD'])) { $output .= $data_listing['LM_RES_LANAILEN']."X".$data_listing['LM_RES_LANAIWD']; } else { $output .= "&nbsp;"; }
$output .= "     </td></tr>\n";
$output .= "     <tr><td><b>Dining Room:</b> </td><td>";
if (!empty($data_listing['LM_RES_DR_L']) && !empty($data_listing['LM_RES_DR_W'])) { $output .= $data_listing['LM_RES_DR_L']."X".$data_listing['LM_RES_DR_W']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>BR 3:</b> </td><td>";
if (!empty($data_listing['LM_RES_BR3_L']) && !empty($data_listing['LM_RES_BR3_W'])) { $output .= $data_listing['LM_RES_BR3_L']."X".$data_listing['LM_RES_BR3_W']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>Laundry:</b> </td><td>";
if (!empty($data_listing['LM_RES_LA_L']) && !empty($data_listing['LM_RES_LA_W'])) { $output .= $data_listing['LM_RES_LA_L']."X".$data_listing['LM_RES_LA_W']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>Extra Rm 1:</b> </td><td>";
if (!empty($data_listing['LM_RES_OTH_RM1L']) && !empty($data_listing['LM_RES_OT_RM1W'])) { $output .= $data_listing['LM_RES_OTH_RM1L']."X".$data_listing['LM_RES_OT_RM1W']; } else { $output .= "&nbsp;"; }
$output .= "     </td></tr>\n";
$output .= "     <tr><td><b>Kitchen:</b> </td><td>";
if (!empty($data_listing['LM_RES_KT_L']) && !empty($data_listing['LM_RES_KT_W'])) { $output .= $data_listing['LM_RES_KT_L']."X".$data_listing['LM_RES_KT_W']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>BR 4:</b> </td><td>";
if (!empty($data_listing['LM_RES_BR4_L']) && !empty($data_listing['LM_RES_BR4_W'])) { $output .= $data_listing['LM_RES_BR4_L']."X".$data_listing['LM_RES_BR4_W']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>Garage:</b> </td><td>";
if (!empty($data_listing['LM_RES_GARGLEN']) && !empty($data_listing['LM_RES_GARGWD'])) { $output .= $data_listing['LM_RES_GARGLEN']."X".$data_listing['LM_RES_GARGWD']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>Extra Rm 2:</b> </td><td>";
if (!empty($data_listing['LM_RES_OTH_RM2L']) && !empty($data_listing['LM_RES_OTH_RM2W'])) { $output .= $data_listing['LM_RES_OTH_RM2L']."X".$data_listing['LM_RES_OTH_RM2W']; } else { $output .= "&nbsp;"; }
$output .= "     </td></tr>\n";
$output .= "     <tr><td><b>Family Room:</b> </td><td>";
if (!empty($data_listing['LM_RES_FAM_LTH']) && !empty($data_listing['LM_RES_FAM_WID'])) { $output .= $data_listing['LM_RES_FAM_LTH']."X".$data_listing['LM_RES_FAM_WID']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>Office:</b> </td><td>";
if (!empty($data_listing['LM_RES_OFFLENGT']) && !empty($data_listing['LM_RES_OFFWID'])) { $output .= $data_listing['LM_RES_OFFLENGT']."X".$data_listing['LM_RES_OFFWID']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>Workshop:</b> </td><td>";
if (!empty($data_listing['LM_RES_WKSHPLEN']) && !empty($data_listing['LM_RES_WKSHPWD'])) { $output .= $data_listing['LM_RES_WKSHPLEN']."X".$data_listing['LM_RES_WKSHPWD']; } else { $output .= "&nbsp;"; }
$output .= "     </td>\n";
$output .= "     <td><b>Extra Rm 3:</b> </td><td>";
if (!empty($data_listing['LM_RES_OTH_RM3L']) && !empty($data_listing['LM_RES_OTH_RM3W'])) { $output .= $data_listing['LM_RES_OTH_RM3L']."X".$data_listing['LM_RES_OTH_RM3W']; } else { $output .= "&nbsp;"; }
$output .= "     </td></tr>\n";
$output .= "   </table>\n";
$output .= "  </td>\n";
$output .= " </tr>\n";*/
...
$output .= "     <tr><td><b>Elementary:</b> </td><td>".$data_listing[$db_school_elementary]."</td>\n";
$output .= "     <td><b>Middle:</b> </td><td>".$data_listing[$db_school_middle]."</td>\n";
$output .= "     <td><b>High:</b> </td><td>".$data_listing[$db_school_high]."</td>\n";
$output .= "     <td colspan='2'>&nbsp;</td></tr>\n";
$output .= "   </table><br />\n";
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
