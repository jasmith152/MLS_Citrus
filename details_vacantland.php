...
$output .= "     <tr><td><b>Road Front:</b> </td><td>".$data_listing[$db_bedrooms]."</td>\n";
$output .= "     <td colspan='2'>&nbsp;</td></tr>\n";
$output .= "     <tr><td><b>Apx. Lot Size:</b> </td><td>".$data_listing[$db_lot_size]."</td></tr>\n";
$output .= "     <td colspan='2'>&nbsp;</td></tr>\n";
...
$output .= "     <tr><td><b>On Site Utilities:</b> </td><td>".$data_listing[$db_int_features]."</td></tr>\n";
$output .= "     <tr><td><b>Avail Utilities:</b> </td><td>".$data_listing[$db_ext_features]."</td></tr>\n";
$output .= "     <tr><td><b>Special Info:</b> </td><td>".$data_listing[$db_special_info]."</td></tr>\n";
$output .= "   </table><br />\n";
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
$output .= "     <tr><td><b>Lot Desc:</b> </td><td>".$data_listing[$db_master_bedbath]."</td>\n";
$output .= "     <td><b>Land Use:</b> </td><td>".$data_listing[$db_garage]."</td></tr>\n";
$output .= "     <tr><td><b>Buildings:</b> </td><td>".$data_listing[$db_style]."</td>\n";
$output .= "     <td><b>Sewer/Water:</b> </td><td>".$data_listing[$db_roof]."</td></tr>\n";
$output .= "     <tr><td><b>Comm Amen:</b> </td><td>".$data_listing[$db_heat_cool]."</td>\n";
$output .= "     <td><b>Fencing:</b> </td><td>".$data_listing[$db_floor]."</td></tr>\n";
$output .= "     <tr><td><b>Road Type:</b> </td><td>".$data_listing[$db_road_type]."</td>\n";
$output .= "     <td><b>Possession:</b> </td><td>".$data_listing[$db_sewer_water]."</td></tr>\n";
...
$output .= "     <tr><td><b>Condo Fees:</b> </td><td colspan='3'>".$data_listing[$db_energy_features]."</td></tr>\n";
$output .= "   </table><br />\n";
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
